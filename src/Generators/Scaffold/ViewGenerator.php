...
namespace KoTA206\Generator\Generators\Scaffold;

use Illuminate\Support\Str;
use KoTA206\Generator\Common\CommandData;
use KoTA206\Generator\Generators\BaseGenerator;
use KoTA206\Generator\Utils\FileUtil;
use KoTA206\Generator\Utils\GeneratorFieldsInputUtil;
use KoTA206\Generator\Utils\HTMLFieldGenerator;
...
class ViewGenerator extends BaseGenerator
{
    ...
    public function __construct(CommandData $commandData)
    {
        ...
        $this->templateType = config('KoTA206.laravel_generator.templates', 'core-templates');
    }
