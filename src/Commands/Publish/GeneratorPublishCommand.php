...
class GeneratorPublishCommand extends PublishBaseCommand
{
     ...
     * @var string
     */
    protected $name = 'KoTA206:publish';
    ...
    {
        $apiVersion = config('KoTA206.laravel_generator.api_version', 'v1');
        $apiPrefix = config('KoTA206.laravel_generator.api_prefix', 'api');
    ...
    private function publishTestCases()
    {
        ...
        $testsPath = config('KoTA206.laravel_generator.path.api_test', base_path('tests/'));
