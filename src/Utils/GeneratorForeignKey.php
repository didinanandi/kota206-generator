...
namespace KoTA206\Generator\Utils;

use DB;
use KoTA206\Generator\Common\GeneratorField;
use KoTA206\Generator\Common\GeneratorFieldRelation;
...
class TableFieldsGenerator
{
    ...
    public function __construct($tableName)
    {
        ...
        $this->defaultSearchable = config('KoTA206.laravel_generator.options.tables_searchable_default', false);
    }
    ...
    {
        if (!config('KoTA206.laravel_generator.timestamps.enabled', true)) {
            return [];
        }

        $createdAtName = config('KoTA206.laravel_generator.timestamps.created_at', 'created_at');
        $updatedAtName = config('KoTA206.laravel_generator.timestamps.updated_at', 'updated_at');
        $deletedAtName = config('KoTA206.laravel_generator.timestamps.deleted_at', 'deleted_at');
