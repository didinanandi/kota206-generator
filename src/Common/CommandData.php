...
use KoTA206\Generator\Utils\GeneratorFieldsInputUtil;
use KoTA206\Generator\Utils\TableFieldsGenerator;
...
class CommandData
{
    ...
    {
        $this->commandInfo('Specify fields for the Role Akses (ex: creat, update, delete, etc');
        ...
        try {
            if ($this->getOption('fieldsFile')) {
                ...
                if (file_exists($fieldsFileValue)) {
                    ...
                    $schemaFileDirector = config('KoTA206.laravel_generator.path.schema_files');
